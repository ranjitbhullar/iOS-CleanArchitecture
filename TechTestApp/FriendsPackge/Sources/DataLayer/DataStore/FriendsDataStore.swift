...
public final class FriendsDataStore: FriendsDataStoreProtocol {
    private let service: FriendsServiceProtocol
    
    private let cacheManager: CacheManagerProtocol
    public init(service: FriendsServiceProtocol, cacheManager: CacheManagerProtocol) {
        self.service = service
        self.cacheManager = cacheManager
    }
    
    public func fetchFriendWith(friendId: String) -> FriendResponse {
    ...
    public func fetchFriendsData() -> FriendsResponse {
        let cacheKey = DataConstants.ApiEndpoints.friendsApiUrl
